...
import { GoonHub } from "@/components/GoonHub";
        ...
        >
          <motion.div variants={itemVariants} className="space-y-4 md:space-y-6">
            <TooltipGuide
              ...
              description="Connect with like-minded individuals and share experiences together."
              position="right"
              step={1}
              totalSteps={4}
            >
              <Card className={`${style.cardBg} backdrop-blur ${style.border}`}>
                <CardHeader className="p-4 md:p-6">
                  <CardTitle className={`${style.text} text-lg md:text-xl flex items-center gap-2`}>
